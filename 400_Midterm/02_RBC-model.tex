...
一阶条件为
\begin{align*}
    \cal L_{C_t}&=C_t^{-\sigma}-\lambda_t=0 \\
    \cal L_{K_t}&=-\lambda_t+\beta\,\mean_t\bks{\lambda_{t+1}\bka{\alpha\, Z_{t+1}\,K_t^{\alpha-1}+1-\delta}}=0\\
    \cal L_{\lambda_t}&=C_t+K_t-Z_t\,K\lt^\alpha-\bka{1-\delta}K\lt=0
\end{align*}
